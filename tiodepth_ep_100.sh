#!/bin/bash
#SBATCH --job-name=tiodepth_dinov2_ep100_1_41_61_no_freeze         # 作业名
...
# 运行训练脚本并保存日志
python train_dist_2.py --name TiO-Depth-DINOv2B_rc256_KITTI_S_B8_nofreeze_ep100 \
    --exp_opts options/TiO-Depth/train/tio_depth-dinov2b_384crop256_kitti_stereo_longer.yaml \
    --batch_size 8 \
