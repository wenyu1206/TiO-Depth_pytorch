#!/bin/bash
#SBATCH --job-name=tiodepth-dav2          # 作业名
...
python train_dist_2.py \
    --name TiO-Depth-DAv2-flsea-all \
    --exp_opts options/TiO-Depth/train/tio_depth-dav2-flsea.yaml \
    --batch_size 8 \
